                ...
                <el-card class="box-card">
                    ...
                    <el-form :inline="true" label-width="90px" class="text-left">
                        ...
                        <el-form-item label="concurrency">
                            ...
                            <el-input v-model="sForm.allocate.concurrency" v-setting/>
                        </el-form-item>
                        <el-form-item label="refresh">
                            ...
                            <el-input v-model="sForm.allocate.refresh" v-setting/>
                        </el-form-item>
                    </el-form>
                </el-card>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            changeProtocol() {
                //this.sForm.protocol = selProtocol;
                // if (selProtocol === "http") {
                //     this.inbound.settings = {
                //         "timeout": 30,
                //         "accounts": [{"user":"bwt", "pass":"bwt@1234"}],
                //         "allowTransparent": true,
                //         "userLevel": 1
                //     };
                // } else if (selProtocol === "vmess") {
                //     this.inbound.settings = {
                //         "clients": [
                //             {
