            ...
            <el-row >
                <el-col :span="8">
                    <el-form-item label="handshake">
                        ...
                        <el-input v-model="sForm.handshake" v-setting/>
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="connIdle">
                        ...
                        <el-input v-model="sForm.connIdle" v-setting/>
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="bufferSize">
                        ...
                        <el-input v-model="sForm.bufferSize" v-setting/>
                    </el-form-item>
                </el-col>
                ...
                <el-col :span="8">
                    <el-form-item label="uplinkOnly">
                        ...
                        <el-input v-model="sForm.uplinkOnly" v-setting/>
                    </el-form-item>
                </el-col>
                ...
                <el-col :span="8">
                    <el-form-item label="downlinkOnly">
                        ...
                        <el-input v-model="sForm.downlinkOnly" v-setting/>
                    </el-form-item>
                </el-col>
